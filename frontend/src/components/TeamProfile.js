...
//     const member = team.members.find(m => m.user._id === user._id || m.user._id === user.userId);
...
//               <button 
//                 className={`tp_tab ${activeTab === 'requests' ? 'tp_active' : ''}`}
...
//             ) : null}
//             {/* <button 
//               className={`tp_tab ${activeTab === 'members' ? 'tp_active' : ''}`}
//               onClick={() => setActiveTab('members')}
//             >
//               Members
//             </button>sfgh */}
//             <button 
//               // className={`tp_tab ${activeTab === 'chat' ? 'tp_active' : ''}`}
...
//                             </span>
//                             {user?.stats?.solvedProblems?.some(id => id.toString() === problem._id.toString()) && (
//                               <span className="tp_problem-solved" style={{ color: 'var(--success)', marginLeft: '8px' }}>
//                                 ✓ Done
//                               </span>
//                             )}
//                           </div>
...
//             )}
//             {activeTab === 'requests' && (
//               <div className="tp_requests-tab">
//                 <h2>Problem Requests</h2>
//                 {problemRequests.length === 0 ? (
//                   <div className="tp_no-requests">
//                     <p>No pending problem requests.</p>
//                   </div>
//                 ) : (
//                   <div className="tp_requests-list">
//                     {problemRequests.map((request) => (
//                       <div key={request._id} className="tp_request-card">
//                         <div className="tp_request-info">
//                           <div className="tp_request-title">
//                             {request.problem.title}
//                           </div>
//                           <div className="tp_request-meta">
//                             <span className={`tp_difficulty tp_${request.problem.difficulty.toLowerCase()}`}>
//                               {request.problem.difficulty}
//                             </span>
//                             <span className="tp_requested-by">
//                               Requested by @{request.requestedBy.username}
//                             </span>
//                             <span className="tp_requested-at">
//                               <Clock size={14} /> {formatDate(request.requestedAt)}
//                             </span>
//                           </div>
//                           {request.notes && <p className="tp_request-notes">{request.notes}</p>}
//                           <div className="tp_request-actions">
//                             <button 
//                               className="tp_approve-btn"
//                               onClick={() => handleApproveRequest(request._id)}
//                             >
//                               Approve
//                             </button>
//                             <button 
//                               className="tp_reject-btn"
